...
function SidebarProvider({
  ...
  const contextValue = React.useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, isRTL, openMobile, setOpenMobile, toggleSidebar]
  );
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeftIcon className={cn(isRTL && 'rotate-180')} />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // RTL-aware positioning
        isRTL ? 'absolute top-3.5 left-3' : 'absolute top-3.5 right-3',
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // RTL-aware positioning
        isRTL ? 'absolute top-1.5 left-1' : 'absolute top-1.5 right-1',
        // Increases the hit area of the button on mobile.
        'after:absolute after:-inset-2 md:after:hidden',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // RTL-aware positioning
        isRTL ? 'absolute left-1' : 'absolute right-1',
  ...
  return (
    <ul
      ...
      className={cn(
        ...
        // RTL-aware border and translate
        isRTL ? '-translate-x-px border-r' : 'translate-x-px border-l',
        'group-data-[collapsible=icon]:hidden',
        className
      )}
      {...props}
